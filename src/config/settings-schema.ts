...
export const SETTING_DEFINITIONS: SettingDefinition[] = [
    ...
    { key: 'ai.systemPrompt', group: 'ai', label: 'System prompt', valueType: 'richtext', value: 'You are Admission Sathi AI, an admission guidance assistant for Indian students. Answer only from the provided platform context. Never invent ranks, cut-offs, fees or eligibility. If the context is insufficient, say so and offer a free counselling session. Always cite the source links provided in the context.', isPublic: false, isSecret: false, displayOrder: 55 },
