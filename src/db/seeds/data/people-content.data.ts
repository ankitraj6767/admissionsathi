...
export interface CounsellorSeed {
    ...
    /**
     * States this counsellor covers, as state slugs.
     *
     * Drives `focusStates`, which `/counselling/state/[slug]` uses to list the
     * counsellors covering a state, and which `pickCounsellorForAssignment` prefers
     * when routing a lead from that state.
     */
    stateSlugs: string[];
...
export const COUNSELLOR_SEEDS: CounsellorSeed[] = [
    { name: 'Ananya Deshpande', slug: 'ananya-deshpande', designation: 'Senior Career Counsellor', email: 'ananya.deshpande@admissionsathi.org', experienceYears: 11, languages: ['English', 'Hindi', 'Marathi'], specializations: ['Engineering admissions', 'JEE counselling', 'Career mapping'], categorySlugs: ['engineering', 'bca-it'], stateSlugs: ['maharashtra', 'goa', 'gujarat', 'madhya-pradesh'], qualifications: ['M.A. Psychology', 'Certified Career Analyst'], rating: 4.8, ratingCount: 214, featured: true },
    { name: 'Rahul Verma', slug: 'rahul-verma', designation: 'Medical Admissions Specialist', email: 'rahul.verma@admissionsathi.org', experienceYears: 9, languages: ['English', 'Hindi'], specializations: ['NEET UG counselling', 'State medical quotas', 'MBBS abroad'], categorySlugs: ['medical', 'nursing'], stateSlugs: ['delhi', 'uttar-pradesh', 'haryana', 'rajasthan', 'uttarakhand'], qualifications: ['B.Sc, MBA (Healthcare)'], rating: 4.7, ratingCount: 186, featured: true },
    { name: 'Meera Krishnan', slug: 'meera-krishnan', designation: 'Management Career Coach', email: 'meera.krishnan@admissionsathi.org', experienceYears: 13, languages: ['English', 'Tamil', 'Hindi'], specializations: ['MBA admissions', 'CAT/XAT strategy', 'Profile building'], categorySlugs: ['management'], stateSlugs: ['tamil-nadu', 'karnataka', 'telangana', 'andhra-pradesh'], qualifications: ['MBA (Finance)'], rating: 4.9, ratingCount: 241, featured: true },
    { name: 'Imran Sheikh', slug: 'imran-sheikh', designation: 'Law Admissions Counsellor', email: 'imran.sheikh@admissionsathi.org', experienceYears: 7, languages: ['English', 'Hindi', 'Urdu'], specializations: ['CLAT counselling', 'NLU preferences'], categorySlugs: ['law'], stateSlugs: ['delhi', 'uttar-pradesh', 'bihar', 'jharkhand'], qualifications: ['BA LLB'], rating: 4.6, ratingCount: 132 },
    { name: 'Sneha Patil', slug: 'sneha-patil', designation: 'Education Finance Advisor', email: 'sneha.patil@admissionsathi.org', experienceYears: 8, languages: ['English', 'Hindi', 'Marathi'], specializations: ['Education loans', 'Scholarship applications'], categorySlugs: ['management', 'engineering'], stateSlugs: ['maharashtra', 'karnataka', 'goa', 'madhya-pradesh'], qualifications: ['M.Com, CFP'], rating: 4.7, ratingCount: 158, featured: true },
    { name: 'Arjun Nair', slug: 'arjun-nair', designation: 'Pharmacy & Allied Health Counsellor', email: 'arjun.nair@admissionsathi.org', experienceYears: 6, languages: ['English', 'Malayalam', 'Hindi'], specializations: ['Pharmacy admissions', 'Paramedical pathways'], categorySlugs: ['pharmacy', 'paramedical'], stateSlugs: ['kerala', 'tamil-nadu', 'karnataka'], qualifications: ['B.Pharm, MBA'], rating: 4.5, ratingCount: 98 },
    { name: 'Kavita Yadav', slug: 'kavita-yadav', designation: 'Nursing Admissions Counsellor', email: 'kavita.yadav@admissionsathi.org', experienceYears: 10, languages: ['English', 'Hindi'], specializations: ['Nursing admissions', 'Government nursing quotas'], categorySlugs: ['nursing'], stateSlugs: ['uttar-pradesh', 'bihar', 'haryana', 'punjab', 'rajasthan'], qualifications: ['M.Sc Nursing'], rating: 4.6, ratingCount: 121 },
    { name: 'Devansh Mehta', slug: 'devansh-mehta', designation: 'Engineering Counselling Expert', email: 'devansh.mehta@admissionsathi.org', experienceYears: 12, languages: ['English', 'Hindi', 'Gujarati'], specializations: ['JoSAA & CSAB choice filling', 'Branch selection'], categorySlugs: ['engineering'], stateSlugs: ['gujarat', 'rajasthan', 'maharashtra', 'madhya-pradesh'], qualifications: ['B.Tech, M.Tech'], rating: 4.8, ratingCount: 267, featured: true },
    { name: 'Priya Sarkar', slug: 'priya-sarkar', designation: 'Career Psychologist', email: 'priya.sarkar@admissionsathi.org', experienceYears: 14, languages: ['English', 'Bengali', 'Hindi'], specializations: ['Aptitude assessment', 'Stream selection after Class 10'], categorySlugs: ['engineering', 'management', 'medical'], stateSlugs: ['west-bengal', 'odisha', 'assam', 'jharkhand', 'bihar'], qualifications: ['M.Phil Psychology'], rating: 4.9, ratingCount: 302, featured: true },
    { name: 'Nitin Rathore', slug: 'nitin-rathore', designation: 'Study Abroad Advisor', email: 'nitin.rathore@admissionsathi.org', experienceYears: 9, languages: ['English', 'Hindi'], specializations: ['Overseas admissions', 'Visa documentation', 'Loan structuring'], categorySlugs: ['management', 'engineering'], stateSlugs: ['delhi', 'punjab', 'haryana', 'chhattisgarh', 'uttarakhand'], qualifications: ['MBA (International Business)'], rating: 4.5, ratingCount: 143 },
];
