...
/** Skeleton for the college counselling landing: content column + booking form column. */
export default function CollegeCounsellingLoading() {
    return (
        <div className="shell py-6" aria-busy="true" aria-live="polite">
            <span className="sr-only">Loading college counselling</span>
