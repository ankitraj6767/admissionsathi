...
/** Skeleton for the course counselling landing: content column + booking form column. */
export default function CourseCounsellingLoading() {
    return (
        <div className="shell py-6" aria-busy="true" aria-live="polite">
            <span className="sr-only">Loading course counselling</span>
